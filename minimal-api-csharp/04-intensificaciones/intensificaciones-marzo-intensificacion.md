# Intensificación de marzo — Intensificación del camino mínimo completo
...
| Campo | Detalle |
| --- | --- |
| Momento | Intensificación de marzo — intensificación (fuera de la estructura anual de 36 encuentros) |
...
| Evaluación | Prueba práctica individual en versiones A y B (`evaluaciones/evaluacion-intensificaciones-marzo.md`), con criterio Apto / No apto aún por objetivo mínimo |
...
| Bloque 2 | 90 | Evaluación del momento: prueba práctica individual en versiones A y B sobre `hospital.db` y el repositorio del grupo (`evaluaciones/evaluacion-intensificaciones-marzo.md`) |
...
- El momento no imparte contenidos nuevos. **El estándar de evaluación es idéntico al de diciembre** (`intensificaciones-diciembre-intensificacion.md`): la prueba de marzo recorre el mismo camino mínimo completo, con versiones A y B equivalentes a las de diciembre en objetivos y exigencia; lo único que cambia es el tiempo de preparación que tuvo cada estudiante.
