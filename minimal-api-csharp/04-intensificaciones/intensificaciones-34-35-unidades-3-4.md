# Momento de intensificación y fortalecimiento (encuentros 34 y 35) — Recuperación y profundización de las Unidades 3 y 4

> Momento de intensificación y fortalecimiento diferenciado del curso **Minimal API con C# .NET 6**: dos pistas en paralelo (recuperación y profundización) con plenarias conjuntas de apertura y cierre. No imparte contenido nuevo. La evaluación del momento, en versiones A y B equivalentes, está en `evaluaciones/evaluacion-intensificaciones-34-35.md`.
...
Agenda del momento de intensificación y fortalecimiento: plenaria de apertura (20 min), bloque 1 (90 min), bloque 2 (90 min) y plenaria de cierre (40 min). Las dos pistas corren en paralelo durante los bloques.
...
| Bloque 2 | 90 min | **Evaluación del momento de intensificación y fortalecimiento en versiones A y B**: ejercicio práctico individual con computadora sobre `hospital.db` + flujo issue → rama → PR. Rinden todos los presentes, cualquiera sea su pista | Misma evaluación |
...
- La evaluación del momento de intensificación y fortalecimiento se aplica en el **bloque 2 del Encuentro 35** (90 minutos de resolución); la revisión de los pull requests y el registro ocurren en la plenaria de cierre.
...
- Documentos: `evaluaciones/evaluacion-intensificaciones-34-35.md` (base), `evaluaciones/evaluacion-intensificaciones-34-35-version-a.md`, `evaluaciones/evaluacion-intensificaciones-34-35-version-b.md` y el anexo docente con las soluciones y los criterios por objetivo.
