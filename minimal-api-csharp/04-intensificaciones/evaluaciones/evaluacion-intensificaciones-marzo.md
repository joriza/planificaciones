# Evaluación de la intensificación de marzo — Intensificación del camino mínimo

> Evaluación del momento de intensificación de marzo (fuera de la planificación anual) · Curso: Minimal API con C# .NET 6. Este documento se entrega junto con la versión asignada (A o B). Leerlo completo antes de comenzar.

## 1. Identificación

| Campo | Detalle |
| --- | --- |
| Instancia | Intensificación de marzo — intensificación del camino mínimo completo |
...
- La constancia del ítem 6 va en el repositorio del grupo de cada estudiante; si rinde más de un integrante del mismo grupo, cada uno trabaja en su propia subcarpeta dentro de `intensificaciones-marzo/`.
