# Evaluación del momento de intensificación y fortalecimiento 2 y 3 — Saberes previos — Versión B

> Dominio de esta versión: playlist de una aplicación de música (canciones). Ejercicio individual en papel: 25 minutos, sin computadora, sin celular, sin material consultable salvo esta hoja. Las condiciones completas y la regla de equivalencia están en `evaluacion-intensificaciones-02-03.md`.
