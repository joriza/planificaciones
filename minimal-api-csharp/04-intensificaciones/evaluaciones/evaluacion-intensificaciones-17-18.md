# Evaluación del momento de intensificación y fortalecimiento 17-18 — Recuperación y profundización de las Unidades 1 y 2

> Evaluación del Encuentro 18 (bloque 2) — Momento de intensificación y fortalecimiento «Recuperación y profundización de las Unidades 1 y 2 (primera instancia)». Curso: Minimal API con C# .NET 6. Este documento se entrega junto con la versión asignada (A o B). Leerlo completo antes de comenzar.

## 1. Identificación

| Campo | Detalle |
| --- | --- |
| Instancia | Encuentro 18 — bloque 2 del momento de intensificación y fortalecimiento 17-18 |
...
La prueba evalúa los siete objetivos mínimos del momento de intensificación y fortalecimiento. Cada objetivo se registra **Apto** o **No apto aún**; no hay puntaje numérico. El resultado es aún provisorio: los objetivos No apto aún se retoman en las instancias de intensificación posteriores a la cursada (diciembre y, de ser necesario, marzo).
...
- Entrega: al finalizar el bloque 2 (o al agotarse el tiempo), el trabajo se sube al repositorio del grupo en la carpeta `intensificaciones-17-18/`, con commits referentes y push. El tiempo agotado no invalida la prueba: se registra la evidencia parcial alcanzada, objetivo por objetivo.
