# Intensificación de diciembre — Intensificación del camino mínimo completo

> Momento de intensificación y fortalecimiento (recuperación pedagógica) **fuera de la planificación anual** (ver la sección [Momentos de intensificación y fortalecimiento] del prompt principal, `0-prompt-plantilla-planificacion.md`): se dicta en diciembre, finalizada la cursada regular, para quienes no alcanzaron los objetivos mínimos del ciclo. Es un momento de **solo intensificación**: no tiene pista de profundización y **no imparte contenidos nuevos**. Su nombre es referencial y ordena alfabéticamente después de los documentos numerados de los momentos.

## 1. Metadatos del momento

| Campo | Detalle |
| --- | --- |
| Momento | Intensificación de diciembre — intensificación (fuera de la estructura anual de 36 encuentros) |
...
| Evaluación | Prueba práctica individual en versiones A y B (`evaluaciones/evaluacion-intensificaciones-diciembre.md`), con criterio Apto / No apto aún por objetivo mínimo |
...
| Bloque 2 | 90 | Evaluación del momento: prueba práctica individual en versiones A y B sobre `hospital.db` y el repositorio del grupo (`evaluaciones/evaluacion-intensificaciones-diciembre.md`) |
...
- **No apto aún:** al menos un objetivo queda sin lograr. No es una calificación final: habilita el plan de trabajo de marzo (`intensificaciones-marzo-intensificacion.md`), que evalúa el mismo camino mínimo con el mismo estándar, con más tiempo de preparación.
