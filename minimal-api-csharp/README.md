...
El ciclo lectivo sigue una estructura fija de 36 encuentros organizados en 16 tramos: encuadre y diagnóstico (encuentro 1), recuperación y profundización de saberes previos (encuentros 2-3), cuatro unidades didácticas con su encuentro dedicado de evaluación (encuentros 4-9, 10-15, 21-26 y 27-32), cierres integradores cuatrimestrales (encuentros 16 y 33), momentos especiales de recuperación y profundización (encuentros 17-20 y 34-35) y cierre integral (encuentro 36). La terminal, git y GitHub, y el trabajo colaborativo se enseñan de forma explícita antes de su primer uso y se ejercitan como saberes transversales durante todo el año.
...
| Documento | Qué es y cuándo se usa |
| --- | --- |
| [planificacion-anual.md](01-planificacion/planificacion-anual.md) | Documento madre del curso: presentación, fundamentación, organización de los 16 tramos del ciclo anual (una fila por tramo), ejes temáticos y nota de correlación. Se usa como referencia institucional de toda la cursada y como punto de partida obligatorio de cualquier cambio posterior. |
| [planificacion-anual.csv](01-planificacion/planificacion-anual.csv) | Versión CSV de la planificación anual (separador `;`, UTF-8 con BOM), para su carga en la planilla institucional de la escuela. |
| [libro-de-aula-1-linea-por-encuentro.md](01-planificacion/libro-de-aula-1-linea-por-encuentro.md) | Síntesis del plan de clases con una línea por encuentro (36 filas), para completar el libro de aula. El docente completa manualmente Fecha y Material al dictar cada encuentro. |
| [libro-de-aula-1-linea-por-encuentro.csv](01-planificacion/libro-de-aula-1-linea-por-encuentro.csv) | Versión CSV del libro de aula de 1 línea por encuentro, para abrir en planilla. |
| [libro-de-aula-2-lineas-por-encuentro.md](01-planificacion/libro-de-aula-2-lineas-por-encuentro.md) | Versión del libro de aula con 2 líneas por encuentro (72 filas), para instituciones que solicitan mayor detalle. |
| [libro-de-aula-2-lineas-por-encuentro.csv](01-planificacion/libro-de-aula-2-lineas-por-encuentro.csv) | Versión CSV del libro de aula de 2 líneas por encuentro. |
...
### 2.4 Carpeta `03-instancias/` — instancias del ciclo anual

Documentos de encuadre y cierres definidos en la estructura anual. No imparten contenido nuevo.

| Documento | Qué es y cuándo se usa |
| --- | --- |
| [instancia-01-encuadre-y-diagnostico.md](03-instancias/instancia-01-encuadre-y-diagnostico.md) | Encuentro 1: presentación de la asignatura y contrato pedagógico; seguridad e higiene y EPP del aula-taller (modalidad técnica); diagnóstico de saberes previos. Se usa al inicio del ciclo lectivo. |
| [instancia-16-cierre-cuatrimestre-1.md](03-instancias/instancia-16-cierre-cuatrimestre-1.md) | Encuentro 16: cierre integrador del cuatrimestre 1, con evaluación integradora y metacognición. Se usa al finalizar el primer cuatrimestre. |
| [evaluacion-cuatrimestre-1.md](03-instancias/evaluacion-cuatrimestre-1.md) | Metadatos y acuerdos de la evaluación integradora cuatrimestral del cierre 16. Se usa en conjunto con la instancia. |
| [evaluacion-cuatrimestre-1-version-a.md](03-instancias/evaluacion-cuatrimestre-1-version-a.md) · [evaluacion-cuatrimestre-1-version-b.md](03-instancias/evaluacion-cuatrimestre-1-version-b.md) | Consigna integradora en dos versiones equivalentes. |
| [evaluacion-cuatrimestre-1-version-a-anexo-docente.md](03-instancias/evaluacion-cuatrimestre-1-version-a-anexo-docente.md) · [evaluacion-cuatrimestre-1-version-b-anexo-docente.md](03-instancias/evaluacion-cuatrimestre-1-version-b-anexo-docente.md) | Anexos docentes (solo docente) con soluciones y criterios de corrección de las versiones A y B. |
| [instancia-33-cierre-cuatrimestre-2.md](03-instancias/instancia-33-cierre-cuatrimestre-2.md) | Encuentro 33: cierre integrador del cuatrimestre 2, con evaluación integradora y metacognición anual. Se usa al finalizar el segundo cuatrimestre. |
| [evaluacion-cuatrimestre-2.md](03-instancias/evaluacion-cuatrimestre-2.md) | Metadatos y acuerdos de la evaluación integradora cuatrimestral del cierre 33. |
| [evaluacion-cuatrimestre-2-version-a.md](03-instancias/evaluacion-cuatrimestre-2-version-a.md) · [evaluacion-cuatrimestre-2-version-b.md](03-instancias/evaluacion-cuatrimestre-2-version-b.md) | Consigna integradora en dos versiones equivalentes. |
| [evaluacion-cuatrimestre-2-version-a-anexo-docente.md](03-instancias/evaluacion-cuatrimestre-2-version-a-anexo-docente.md) · [evaluacion-cuatrimestre-2-version-b-anexo-docente.md](03-instancias/evaluacion-cuatrimestre-2-version-b-anexo-docente.md) | Anexos docentes (solo docente) con soluciones y criterios de corrección de las versiones A y B. |
| [instancia-36-cierre-integral.md](03-instancias/instancia-36-cierre-integral.md) | Encuentro 36: cierre integral de la asignatura; balance del recorrido, metacognición final y proyección formativa, sin contenidos nuevos y sin versión A/B. Se usa en el último encuentro del ciclo. |

### 2.5 Carpeta `04-especiales/` — encuentros especiales y sus evaluaciones

Un documento por cada momento especial, cubriendo los encuentros que el momento define. Los momentos dentro de la estructura anual no imparten contenido nuevo; diciembre y marzo (fuera de la planificación anual) evalúan el camino mínimo completo del curso. Cada momento tiene su evaluación en dos versiones equivalentes, con su anexo docente (solo docente) en la subcarpeta `evaluaciones/`.

| Momento | Documento del momento | Evaluaciones (subcarpeta `evaluaciones/`) |
| --- | --- | --- |
| Saberes previos (encuentros 2-3) | [especiales-02-03-saberes-previos.md](04-especiales/especiales-02-03-saberes-previos.md) | [base](04-especiales/evaluaciones/evaluacion-especiales-02-03.md) · [versión A](04-especiales/evaluaciones/evaluacion-especiales-02-03-version-a.md) · [versión B](04-especiales/evaluaciones/evaluacion-especiales-02-03-version-b.md) · [anexo docente](04-especiales/evaluaciones/evaluacion-especiales-02-03-anexo-docente.md) |
| Recuperación y profundización de las Unidades 1 y 2 (encuentros 17-18) | [especiales-17-18-unidades-1-2.md](04-especiales/especiales-17-18-unidades-1-2.md) | [base](04-especiales/evaluaciones/evaluacion-especiales-17-18.md) · [versión A](04-especiales/evaluaciones/evaluacion-especiales-17-18-version-a.md) · [versión B](04-especiales/evaluaciones/evaluacion-especiales-17-18-version-b.md) · [anexo docente](04-especiales/evaluaciones/evaluacion-especiales-17-18-anexo-docente.md) |
| Instancia integradora de las Unidades 1 y 2, proyecto puente (encuentros 19-20) | [especiales-19-20-integradora-1-2.md](04-especiales/especiales-19-20-integradora-1-2.md) | [base](04-especiales/evaluaciones/evaluacion-especiales-19-20.md) · [versión A](04-especiales/evaluaciones/evaluacion-especiales-19-20-version-a.md) · [versión B](04-especiales/evaluaciones/evaluacion-especiales-19-20-version-b.md) · [anexo docente](04-especiales/evaluaciones/evaluacion-especiales-19-20-anexo-docente.md) |
| Recuperación y profundización de las Unidades 3 y 4 (encuentros 34-35) | [especiales-34-35-unidades-3-4.md](04-especiales/especiales-34-35-unidades-3-4.md) | [base](04-especiales/evaluaciones/evaluacion-especiales-34-35.md) · [versión A](04-especiales/evaluaciones/evaluacion-especiales-34-35-version-a.md) · [versión B](04-especiales/evaluaciones/evaluacion-especiales-34-35-version-b.md) · [anexo docente](04-especiales/evaluaciones/evaluacion-especiales-34-35-anexo-docente.md) |
| Intensificación de diciembre (fuera de la planificación anual) | [especiales-diciembre-intensificacion.md](04-especiales/especiales-diciembre-intensificacion.md) | [base](04-especiales/evaluaciones/evaluacion-especiales-diciembre.md) · [versión A](04-especiales/evaluaciones/evaluacion-especiales-diciembre-version-a.md) · [versión B](04-especiales/evaluaciones/evaluacion-especiales-diciembre-version-b.md) · [anexo docente](04-especiales/evaluaciones/evaluacion-especiales-diciembre-anexo-docente.md) |
| Intensificación de marzo (fuera de la planificación anual) | [especiales-marzo-intensificacion.md](04-especiales/especiales-marzo-intensificacion.md) | [base](04-especiales/evaluaciones/evaluacion-especiales-marzo.md) · [versión A](04-especiales/evaluaciones/evaluacion-especiales-marzo-version-a.md) · [versión B](04-especiales/evaluaciones/evaluacion-especiales-marzo-version-b.md) · [anexo docente](04-especiales/evaluaciones/evaluacion-especiales-marzo-anexo-docente.md) |
...
2. **Planificación anual**, documento madre: [planificacion-anual.md](01-planificacion/planificacion-anual.md) y su versión [planificacion-anual.csv](01-planificacion/planificacion-anual.csv).
3. **Libro de aula**, derivado directo de la anual: [libro-de-aula-1-linea-por-encuentro.md](01-planificacion/libro-de-aula-1-linea-por-encuentro.md) con su [CSV](01-planificacion/libro-de-aula-1-linea-por-encuentro.csv), y [libro-de-aula-2-lineas-por-encuentro.md](01-planificacion/libro-de-aula-2-lineas-por-encuentro.md) con su [CSV](01-planificacion/libro-de-aula-2-lineas-por-encuentro.csv).
...
9. **Instancias del ciclo**: [instancia-01-encuadre-y-diagnostico.md](03-instancias/instancia-01-encuadre-y-diagnostico.md); luego [instancia-16-cierre-cuatrimestre-1.md](03-instancias/instancia-16-cierre-cuatrimestre-1.md) con la evaluación cuatrimestral 1 ([base](03-instancias/evaluacion-cuatrimestre-1.md), [A](03-instancias/evaluacion-cuatrimestre-1-version-a.md), [B](03-instancias/evaluacion-cuatrimestre-1-version-b.md) y anexos docentes de [A](03-instancias/evaluacion-cuatrimestre-1-version-a-anexo-docente.md) y [B](03-instancias/evaluacion-cuatrimestre-1-version-b-anexo-docente.md)); luego [instancia-33-cierre-cuatrimestre-2.md](03-instancias/instancia-33-cierre-cuatrimestre-2.md) con la evaluación cuatrimestral 2 ([base](03-instancias/evaluacion-cuatrimestre-2.md), [A](03-instancias/evaluacion-cuatrimestre-2-version-a.md), [B](03-instancias/evaluacion-cuatrimestre-2-version-b.md) y anexos docentes de [A](03-instancias/evaluacion-cuatrimestre-2-version-a-anexo-docente.md) y [B](03-instancias/evaluacion-cuatrimestre-2-version-b-anexo-docente.md)); finalmente [instancia-36-cierre-integral.md](03-instancias/instancia-36-cierre-integral.md).
10. **Encuentros especiales** (6 momentos) con sus evaluaciones: [especiales-02-03-saberes-previos.md](04-especiales/especiales-02-03-saberes-previos.md), [especiales-17-18-unidades-1-2.md](04-especiales/especiales-17-18-unidades-1-2.md), [especiales-19-20-integradora-1-2.md](04-especiales/especiales-19-20-integradora-1-2.md), [especiales-34-35-unidades-3-4.md](04-especiales/especiales-34-35-unidades-3-4.md), [especiales-diciembre-intensificacion.md](04-especiales/especiales-diciembre-intensificacion.md), [especiales-marzo-intensificacion.md](04-especiales/especiales-marzo-intensificacion.md); y, en `04-especiales/evaluaciones/`, base, versiones A y B y anexo docente para cada momento: [evaluacion-especiales-02-03](04-especiales/evaluaciones/evaluacion-especiales-02-03.md), [evaluacion-especiales-17-18](04-especiales/evaluaciones/evaluacion-especiales-17-18.md), [evaluacion-especiales-19-20](04-especiales/evaluaciones/evaluacion-especiales-19-20.md), [evaluacion-especiales-34-35](04-especiales/evaluaciones/evaluacion-especiales-34-35.md), [evaluacion-especiales-diciembre](04-especiales/evaluaciones/evaluacion-especiales-diciembre.md), [evaluacion-especiales-marzo](04-especiales/evaluaciones/evaluacion-especiales-marzo.md).
...
La planificación anual ([`01-planificacion/planificacion-anual.md`](01-planificacion/planificacion-anual.md)) es el **documento madre** del curso: el libro de aula, las unidades didácticas y sus clases, las evaluaciones, las instancias del ciclo, los encuentros especiales, la continuidad pedagógica y los criterios de aprobación derivan de ella con correlación exacta de numeración de encuentros, denominaciones de tramos, ejes, tiempos y momentos de evaluación y recuperación. Todo cambio futuro se ajusta **primero** en la planificación anual y se propaga **en cascada** a los documentos derivados; nunca se dejan documentos desalineados. Ante cualquier duda técnica de contenido, decide la hoja de [convenciones-tecnicas.md](convenciones-tecnicas.md).
