# Anexo docente — Evaluación del momento especial 34-35 (versiones A y B)
...
- Preparar la carpeta `especiales-34-35/` como consigna: cada alumno crea su propio `defecto-<inicial>.cs` copiando el snippet provisto en su enunciado; no hace falta un archivo pre-cargado en los repos.
