# Evaluación del especial de marzo — Versión A

> Dominio de esta versión: ingresos (tablas `admissions` y `doctors` de `hospital.db`). Duración: 90 minutos. Resolución individual, sin celular, sin material consultable salvo lo provisto con esta prueba. Las condiciones completas y el criterio de resultado están en `evaluacion-especiales-marzo.md`.
