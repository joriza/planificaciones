# Evaluación del especial de diciembre — Intensificación del camino mínimo

> Evaluación del momento especial de diciembre (fuera de la planificación anual) · Curso: Minimal API con C# .NET 6. Este documento se entrega junto con la versión asignada (A o B). Leerlo completo antes de comenzar.

## 1. Identificación

| Campo | Detalle |
| --- | --- |
| Instancia | Especial de diciembre — intensificación del camino mínimo completo |
...
- **No apto aún:** al menos un objetivo queda sin lograr. El resultado habilita el plan de trabajo para marzo (`especiales-marzo-intensificacion.md`), que evalúa el mismo camino mínimo con el mismo estándar.
...
- La constancia del ítem 6 va en el repositorio del grupo de cada estudiante; si rinde más de un integrante del mismo grupo, cada uno trabaja en su propia subcarpeta dentro de `especial-diciembre/`.
