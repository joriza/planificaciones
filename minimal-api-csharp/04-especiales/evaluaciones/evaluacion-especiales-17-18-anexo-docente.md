# Anexo docente — Evaluación del momento especial 17-18 (versiones A y B)

> Documento docente formal. No se entrega a los alumnos: contiene la solución completa de las versiones A y B, las respuestas esperadas, los criterios de Apto por objetivo mínimo, los errores previstos y la pauta de registro y devolución. El archivo base es `evaluacion-especiales-17-18.md`.

## 1. Solución completa de la versión A (`Program.cs`)

```csharp
// Program.cs - Momento especial 17-18 - Version A (solucion del docente)
...
```csharp
// Program.cs - Momento especial 17-18 - Version B (solucion del docente)
...
| OM7 | Ciclo de entrega GitHub | Ítem 6 | El trabajo quedó en `especial-17-18/` dentro del repositorio del grupo, con commits referentes por ítem y push visible en GitHub |
...
- La verificación de la entrega por GitHub se realiza en los primeros 15 minutos del plenario de cierre del Encuentro 18; el docente confirma la carpeta `especial-17-18/`, los commits y el push de cada alumno presente.
