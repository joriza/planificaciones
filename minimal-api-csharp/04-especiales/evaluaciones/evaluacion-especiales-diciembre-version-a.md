# Evaluación del especial de diciembre — Versión A

> Dominio de esta versión: médicos (tablas `doctors` y `admissions` de `hospital.db`). Duración: 90 minutos. Resolución individual, sin celular, sin material consultable salvo lo provisto con esta prueba. Las condiciones completas y el criterio de resultado están en `evaluacion-especiales-diciembre.md`.
