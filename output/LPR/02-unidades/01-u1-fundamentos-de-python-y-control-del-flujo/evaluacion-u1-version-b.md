...
No hay esqueleto inicial. El estudiante escribe el programa completo desde cero. Se espera que use un diccionario para los libros de la biblioteca.

## Parte 1 — Menú principal y listado de libros (30 puntos)

Agregá un diccionario `products` con al menos 4 libros de la biblioteca. Cada clave es un código numérico (`int`) y cada valor es un diccionario con `name`, `price` y `ejemplares`.
