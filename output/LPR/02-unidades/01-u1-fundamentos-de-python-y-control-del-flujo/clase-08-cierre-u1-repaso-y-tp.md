...
| Concepto nuevo | Sistematización de U1; TP-U1 (programa de consola con entrada y control de flujo); ciclo de entrega con Git y GitHub |
...
2. Creá un repositorio nuevo con nombre `tp-lpr`.
...
git remote add origin https://github.com/tu-usuario/tp-lpr.git
...
| El menú no vuelve a aparecer después de una opción | Faltó el bucle `while` principal | Envolver el menú + opciones con `while running:` y solo salir con `running = False` |
