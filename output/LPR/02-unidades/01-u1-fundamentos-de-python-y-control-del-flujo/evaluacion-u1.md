...
- **Convenciones obligatorias:** las de `input/materias/LPR/convenciones-tecnicas.md` (snake_case, f-strings, `if __name__`, sin persistencia, sin `except:` desnudo).
