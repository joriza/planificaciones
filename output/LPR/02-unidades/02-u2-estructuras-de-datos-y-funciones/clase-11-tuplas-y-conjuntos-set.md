...
Imaginate que el club tiene tres tipos de registros:
...
3. **Eliminación segura en set:** usá `discard()` en vez de `remove()` para eliminar un elemento que quizá no exista (probá con uno existente y uno inexistente).
