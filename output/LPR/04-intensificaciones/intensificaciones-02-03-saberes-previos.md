...
2. **(15 min)** Práctica guiada: navegar por el sistema, crear la estructura de carpetas del curso (`LPR/`, `LPR/unidad-1/`, etc.) desde la terminal.
...
2. **(15 min)** Desafío: replicar el árbol de directorios de un proyecto Python real (carpetas `LPR/`, `LPR/unidad-1/`, etc.) usando una sola línea de comandos encadenados.
...
3. **(20 min)** Recorrido guiado por el repo: estructura de carpetas `LPR/`, `LPR/unidad-1/`, `LPR/unidad-2/`, `LPR/unidad-3/`, `LPR/trabajo-final/`. Explicación de qué se entrega en cada una y cómo se crea un archivo nuevo.
...
3. **(20 min)** Desafío: crear un archivo `bitacora.md` en su computadora con los comandos y algoritmos trabajados, listo para el repo como primer commit simbólico (el docente guía, sin Git todavía — se usará la interfaz web).
