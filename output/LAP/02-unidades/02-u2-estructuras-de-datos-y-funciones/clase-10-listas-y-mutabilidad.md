...
Imaginá que tenés la lista de socios del club anotada en un pizarrón con tiza. Podés borrar un nombre, agregar otro al final, cambiar el orden. Eso es una **lista**: podés modificarla después de crearla. Ahora imaginá esa misma lista impresa en una foto: no podés tachar ni agregar nombres sin sacar otra foto. Eso es un **tipo inmutable** como el `str` o la `tuple`. Hoy manejamos el pizarrón.
...
# --- Sacar el último ---
print("\nEl secretario pidó borrar el último socio...")
