...
#### Fundamentos de C# y Minimal API (`01-u1-fundamentos-de-csharp-y-minimal-api/`, encuentros 4 a 9)

| Encuentro | Documento del alumno | Qué trabajó | Anexo docente (solo docente) |
| --- | --- | --- | --- |
| 4 | [clase-04-introduccion-a-net-y-csharp.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-04-introduccion-a-net-y-csharp.md) | . | [anexo clase 4](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-04-introduccion-a-net-y-csharp-anexo-docente.md) |
| 5 | [clase-05-estructuras-de-control-y-metodos.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-05-estructuras-de-control-y-metodos.md) | . | [anexo clase 5](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-05-estructuras-de-control-y-metodos-anexo-docente.md) |
| 6 | [clase-06-minimal-api-y-endpoint-get.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-06-minimal-api-y-endpoint-get.md) | . | [anexo clase 6](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-06-minimal-api-y-endpoint-get-anexo-docente.md) |
| 7 | [clase-07-parametros-y-rutas-en-get.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-07-parametros-y-rutas-en-get.md) | . | [anexo clase 7](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-07-parametros-y-rutas-en-get-anexo-docente.md) |
| 8 | [clase-08-cierre-u1-repaso-y-tp.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-08-cierre-u1-repaso-y-tp.md) | . | [anexo clase 8](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/clase-08-cierre-u1-repaso-y-tp-anexo-docente.md) |
| 9 | [evaluacion-u1.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/evaluacion-u1.md) | Encuentro dedicado de evaluación de la Unidad 1: entrega, defensa individual y prueba práctica según los acuerdos de la unidad. Documento de metadatos de la instancia. | — |
| 9 | [evaluacion-u1-version-a.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/evaluacion-u1-version-a.md) · [evaluacion-u1-version-b.md](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/evaluacion-u1-version-b.md) | Prueba práctica individual en versiones equivalentes (mismos objetivos y requisitos, distinto dominio o datos). | [anexo versión A](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/evaluacion-u1-version-a-anexo-docente.md) · [anexo versión B](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/evaluacion-u1-version-b-anexo-docente.md) |

#### Acceso a datos con SQLite y Dapper (`02-u2-acceso-a-datos-con-sqlite-y-dapper/`, encuentros 10 a 15)

| Encuentro | Documento del alumno | Qué trabajó | Anexo docente (solo docente) |
| --- | --- | --- | --- |
| 10 | [clase-10-sqlite-y-select-basico.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-10-sqlite-y-select-basico.md) | . | [anexo clase 10](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-10-sqlite-y-select-basico-anexo-docente.md) |
| 11 | [clase-11-sql-join-y-order-by.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-11-sql-join-y-order-by.md) | . | [anexo clase 11](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-11-sql-join-y-order-by-anexo-docente.md) |
| 12 | [clase-12-dapper-query-t-con-alias.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-12-dapper-query-t-con-alias.md) | . | [anexo clase 12](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-12-dapper-query-t-con-alias-anexo-docente.md) |
| 13 | [clase-13-parametros-y-like-en-dapper.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-13-parametros-y-like-en-dapper.md) | . | [anexo clase 13](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-13-parametros-y-like-en-dapper-anexo-docente.md) |
| 14 | [clase-14-cierre-u2-repaso-y-tp.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-14-cierre-u2-repaso-y-tp.md) | . | [anexo clase 14](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-14-cierre-u2-repaso-y-tp-anexo-docente.md) |
| 15 | [evaluacion-u2.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/evaluacion-u2.md) | Encuentro dedicado de evaluación de la Unidad 2: entrega, defensa individual y prueba práctica según los acuerdos de la unidad. Documento de metadatos de la instancia. | — |
| 15 | [evaluacion-u2-version-a.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/evaluacion-u2-version-a.md) · [evaluacion-u2-version-b.md](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/evaluacion-u2-version-b.md) | Prueba práctica individual en versiones equivalentes (mismos objetivos y requisitos, distinto dominio o datos). | [anexo versión A](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/evaluacion-u2-version-a-anexo-docente.md) · [anexo versión B](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/evaluacion-u2-version-b-anexo-docente.md) |

#### CRUD completo con Dapper (`03-u3-crud-completo-con-dapper/`, encuentros 21 a 26)

| Encuentro | Documento del alumno | Qué trabajó | Anexo docente (solo docente) |
| --- | --- | --- | --- |
| 21 | [clase-21-insert-con-dapper-y-post.md](02-unidades/03-u3-crud-completo-con-dapper/clase-21-insert-con-dapper-y-post.md) | . | [anexo clase 21](02-unidades/03-u3-crud-completo-con-dapper/clase-21-insert-con-dapper-y-post-anexo-docente.md) |
| 22 | [clase-22-delete-con-dapper-y-mapdelete.md](02-unidades/03-u3-crud-completo-con-dapper/clase-22-delete-con-dapper-y-mapdelete.md) | . | [anexo clase 22](02-unidades/03-u3-crud-completo-con-dapper/clase-22-delete-con-dapper-y-mapdelete-anexo-docente.md) |
| 23 | [clase-23-update-con-dapper-y-mapput.md](02-unidades/03-u3-crud-completo-con-dapper/clase-23-update-con-dapper-y-mapput.md) | . | [anexo clase 23](02-unidades/03-u3-crud-completo-con-dapper/clase-23-update-con-dapper-y-mapput-anexo-docente.md) |
| 24 | [clase-24-crud-completo-y-join-triple.md](02-unidades/03-u3-crud-completo-con-dapper/clase-24-crud-completo-y-join-triple.md) | . | [anexo clase 24](02-unidades/03-u3-crud-completo-con-dapper/clase-24-crud-completo-y-join-triple-anexo-docente.md) |
| 25 | [clase-25-cierre-u3-repaso-y-tp.md](02-unidades/03-u3-crud-completo-con-dapper/clase-25-cierre-u3-repaso-y-tp.md) | . | [anexo clase 25](02-unidades/03-u3-crud-completo-con-dapper/clase-25-cierre-u3-repaso-y-tp-anexo-docente.md) |
| 26 | [evaluacion-u3.md](02-unidades/03-u3-crud-completo-con-dapper/evaluacion-u3.md) | Encuentro dedicado de evaluación de la Unidad 3: entrega, defensa individual y prueba práctica según los acuerdos de la unidad. Documento de metadatos de la instancia. | — |
| 26 | [evaluacion-u3-version-a.md](02-unidades/03-u3-crud-completo-con-dapper/evaluacion-u3-version-a.md) · [evaluacion-u3-version-b.md](02-unidades/03-u3-crud-completo-con-dapper/evaluacion-u3-version-b.md) | Prueba práctica individual en versiones equivalentes (mismos objetivos y requisitos, distinto dominio o datos). | [anexo versión A](02-unidades/03-u3-crud-completo-con-dapper/evaluacion-u3-version-a-anexo-docente.md) · [anexo versión B](02-unidades/03-u3-crud-completo-con-dapper/evaluacion-u3-version-b-anexo-docente.md) |

#### Profesionalización y proyecto final (`04-u4-profesionalizacion-proyecto-final/`, encuentros 27 a 32)

| Encuentro | Documento del alumno | Qué trabajó | Anexo docente (solo docente) |
| --- | --- | --- | --- |
| 27 | [clase-27-git-profesional-ramas-pr.md](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-27-git-profesional-ramas-pr.md) | . | [anexo clase 27](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-27-git-profesional-ramas-pr-anexo-docente.md) |
| 28 | [clase-28-readme-portada-main-protegida.md](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-28-readme-portada-main-protegida.md) | . | [anexo clase 28](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-28-readme-portada-main-protegida-anexo-docente.md) |
| 29 | [clase-29-consolidacion-crud-joins.md](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-29-consolidacion-crud-joins.md) | . | [anexo clase 29](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-29-consolidacion-crud-joins-anexo-docente.md) |
| 30 | [clase-30-avance-trabajo-final.md](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-30-avance-trabajo-final.md) | . | [anexo clase 30](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-30-avance-trabajo-final-anexo-docente.md) |
| 31 | [clase-31-cierre-entrega-final.md](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-31-cierre-entrega-final.md) | . | [anexo clase 31](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-31-cierre-entrega-final-anexo-docente.md) |
| 32 | [evaluacion-u4.md](02-unidades/04-u4-profesionalizacion-proyecto-final/evaluacion-u4.md) | Encuentro dedicado de evaluación de la Unidad 4: entrega, defensa individual y prueba práctica según los acuerdos de la unidad. Documento de metadatos de la instancia. | — |
| 32 | [evaluacion-u4-version-a.md](02-unidades/04-u4-profesionalizacion-proyecto-final/evaluacion-u4-version-a.md) · [evaluacion-u4-version-b.md](02-unidades/04-u4-profesionalizacion-proyecto-final/evaluacion-u4-version-b.md) | Prueba práctica individual en versiones equivalentes (mismos objetivos y requisitos, distinto dominio o datos). | [anexo versión A](02-unidades/04-u4-profesionalizacion-proyecto-final/evaluacion-u4-version-a-anexo-docente.md) · [anexo versión B](02-unidades/04-u4-profesionalizacion-proyecto-final/evaluacion-u4-version-b-anexo-docente.md) |
...
6. **Acceso a datos con SQLite y Dapper** (encuentros 10 a 14), cada clase con su anexo docente: [clase-10](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-10-sqlite-y-select-basico.md), [clase-11](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-11-sql-join-y-order-by.md), [clase-12](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-12-dapper-query-t-con-alias.md), [clase-13](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-13-parametros-y-like-en-dapper.md), [clase-14](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/clase-14-cierre-u2-repaso-y-tp.md).
7. **CRUD completo con Dapper** (encuentros 21 a 25), cada clase con su anexo docente: [clase-21](02-unidades/03-u3-crud-completo-con-dapper/clase-21-insert-con-dapper-y-post.md), [clase-22](02-unidades/03-u3-crud-completo-con-dapper/clase-22-delete-con-dapper-y-mapdelete.md), [clase-23](02-unidades/03-u3-crud-completo-con-dapper/clase-23-update-con-dapper-y-mapput.md), [clase-24](02-unidades/03-u3-crud-completo-con-dapper/clase-24-crud-completo-y-join-triple.md), [clase-25](02-unidades/03-u3-crud-completo-con-dapper/clase-25-cierre-u3-repaso-y-tp.md).
8. **Profesionalización y proyecto final** (encuentros 27 a 31), cada clase con su anexo docente: [clase-27](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-27-git-profesional-ramas-pr.md), [clase-28](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-28-readme-portada-main-protegida.md), [clase-29](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-29-consolidacion-crud-joins.md), [clase-30](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-30-avance-trabajo-final.md), [clase-31](02-unidades/04-u4-profesionalizacion-proyecto-final/clase-31-cierre-entrega-final.md).
9. **Evaluaciones de unidad** (documento base, versiones equivalentes y anexos docentes en la carpeta de cada unidad): [evaluacion-u1](02-unidades/01-u1-fundamentos-de-csharp-y-minimal-api/evaluacion-u1.md), [evaluacion-u2](02-unidades/02-u2-acceso-a-datos-con-sqlite-y-dapper/evaluacion-u2.md), [evaluacion-u3](02-unidades/03-u3-crud-completo-con-dapper/evaluacion-u3.md), [evaluacion-u4](02-unidades/04-u4-profesionalizacion-proyecto-final/evaluacion-u4.md).
