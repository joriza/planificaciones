# Evaluación del momento de intensificación y fortalecimiento marzo — Versión B

> Dominio de esta versión: books de soporte (U1, mini API en memoria) y patients/admissions de hospital.db (U2). Duración: 90 minutos. Puntaje total: 100 puntos. Resolución individual, con computadora, sin celular. Las condiciones completas están en `evaluacion-intensificaciones-marzo.md`.
