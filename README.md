...
> El plan de mejoras vigente y su secuencia de ejecución aprobada están documentados en `docs/plan-de-mejoras-del-proyecto.md` (§10): los agentes toman el orden, el alcance y el estado de la secuencia tal como está — no re-analizan ni re-planifican esos pendientes; solo el docente la modifica.
