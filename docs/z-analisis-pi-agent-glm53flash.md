...
5. **Tiempo nominal y tiempo académico efectivo.** Toda planificación curricular maneja dos magnitudes: el tiempo nominal que declara el documento y el tiempo académico efectivo que el grupo realmente aprovecha; la brecha entre ambos es un fenómeno documentado en la investigación didáctica (tiempo planificado frente a tiempo implementado). El sistema la trata como estimado implícito de planificación: no figura en ningún documento generado. De las variantes para conciliar ambos tiempos, la de **actividades de extensión y consolidación explícitas** — declarar dentro del bloque una actividad adicional real para quienes completan la consigna base — es la que mantiene correspondencia exacta entre cada hora declarada y una actividad prevista, y por eso es la que resiste una revisión formal. Estado del corpus: las clases generadas hasta la Unidad 2 usan la tabla estándar 30/45/90/55/20 sin actividades de extensión declaradas; incorporar la variante explícita queda como mejora de plantilla para las próximas corridas.
