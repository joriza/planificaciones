...
## Pendientes de follow-up (fuera de este commit)

1. **lint-canon 16 errores / 2 avisos** en corpus LSO (pre-existentes, verificados sin regresión): repartos que suman 0 min en clases de u1/u2/u4 + 1 registro-tipos `int patient_id` en continuidad-02.
