...
#   9) Cobertura informativa contra la estructura fija de 36 (ver prompt-plantilla-planificacion.md, seccion [Estructura del ciclo lectivo]):
...
foreach ($course in $cursos) {
  ...
  # 9) Cobertura informativa contra la estructura fija del ciclo (espeja prompt-plantilla-planificacion.md, seccion [Estructura del ciclo lectivo]).
  #    No afecta el exit code: reporta avance, no validez formal.
